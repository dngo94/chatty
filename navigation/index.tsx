...
// import UsersScreen from '../screens/UsersScreen';
 ...
 const ChatRoomHeader = (props: { children: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined; }) => {
   ...
   return (
     <View style={{
       ...
       <Feather name="video" size={24} color="#3777f0" style= {{marginHorizontal: 10}}/>
       </View>
   )
 }
